...
public sealed class TestSettings
{
    ...
    public string ScreenshotDirectory { get; init; } = "artifacts/screenshots";
    public string ExtentReportDirectory { get; init; } = "artifacts/extent";
    public string LogDirectory { get; init; } = "artifacts/logs";
}
